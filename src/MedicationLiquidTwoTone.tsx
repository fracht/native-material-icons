...
import Svg, { SvgProps, G, Defs, Path, Use, ClipPath, Ellipse } from 'react-native-svg';

const MedicationLiquidTwoTone = (props: SvgProps) => (
    <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" {...props}>
        <G opacity={0.3}>
            <Defs>
                <Path id="a" d="M4 8h10v11H4z" opacity={0.3} />
            </Defs>
            <Use xlinkHref="#a" overflow="visible" />
            <ClipPath id="b">
                <Use xlinkHref="#a" overflow="visible" />
            </ClipPath>
            <Path d="M4 19h10V8H4v11zm1-7h2.5V9.5h3V12H13v3h-2.5v2.5h-3V15H5v-3z" clipPath="url(#b)" />
        </G>
